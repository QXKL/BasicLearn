package com.qx.basicdemo.AOP.aop_use_cases_006;
...
public class UseCaseAspect {
    ...
    @Pointcut("execution(* com.qx.basicdemo.AOP.aop_use_cases_006.ReportService.*(..))")
    public void reportMethods() {
    }

    @Pointcut("execution(* com.qx.basicdemo.AOP.aop_use_cases_006.ReportService.deleteReport(..))")
